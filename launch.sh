...
READREPLICADBIDENTIFIER=mp-sg-rr
...
CREATE TABLE IF NOT EXISTS introspection(introid INT NOT NULL AUTO_INCREMENT, introspectionavailable VARCHAR(1) NOT NULL, PRIMARY KEY(introid));
...
aws rds create-db-instance-read-replica --db-instance-identifier $READREPLICADBIDENTIFIER --source-db-instance-identifier $DBINSTANCEIDENTIFIER
